...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle node;
    ros::ServiceClient takeoff_land_srv = node.serviceClient<quad_pos_ctrl::SetTakeoffLand>("/quad_pos_ctrl_node/controller/takeoff_land");
    ros::Publisher ctrl_ref_pub = node.advertise<quad_pos_ctrl::ctrl_ref>("/quad_pos_ctrl_node/controller/ctrl_ref",10);
