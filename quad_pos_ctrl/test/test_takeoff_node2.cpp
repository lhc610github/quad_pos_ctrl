...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle node;
    ros::ServiceClient takeoff_land_srv = node.serviceClient<ctrl_msg::SetTakeoffLand>("/quad_pos_ctrl_node1/controller/takeoff_land");
    ros::Publisher ctrl_ref_pub = node.advertise<ctrl_msg::ctrl_ref>("/quad_pos_ctrl_node1/controller/ctrl_ref",10);
