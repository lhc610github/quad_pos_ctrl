...
class State_Estimate_Vio{
    public:
        ...
        void vio_pos_data_cb(const geometry_msgs::PoseStampedPtr _data) {
...
//            pose_pub_.publish(temp_rigid_);
        ...
        void vio_vel_data_cb(const geometry_msgs::Vector3StampedPtr _data) {
            pthread_mutex_lock(&state_mutex);
...
//            vel_pub_.publish(temp_vel_);
        ...
        void vio_acc_data_cb(const geometry_msgs::Vector3StampedPtr _data) {
            pthread_mutex_lock(&state_mutex);
...
//            acc_pub_.publish(temp_acc_);
        ...
        void vio_att_data_cb(const geometry_msgs::PoseStampedPtr _data) {
            pthread_mutex_lock(&state_mutex);
